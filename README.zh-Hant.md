...
PKV Sync 1.2.0 是目前面向 LLM 維護 Wiki 工作流的穩定版本。本版新增原子化 `write_files` 多檔案 MCP 提交，以及保留歷史的 `move_file` 重新命名／移動工具，並包含 v1.1.1 的安全加固；Agent 循環請看 [LLM Wiki 操作指南](./public-docs/llm-wiki-howto.zh-Hant.md)。
