...
PKV Sync 1.2.3은 현재 안정 패치 릴리스입니다. 커뮤니티 디렉터리의 소스 lint 지적 사항을 해결했습니다. 플랫폼 감지는 이제 Platform API를 사용하고, 폴더 조회는 선언된 최소 앱 버전 범위 안에 머무르며, 명령어 ID에서 중복된 플러그인 접두사를 제거했습니다.
