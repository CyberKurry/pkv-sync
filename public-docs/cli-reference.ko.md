...
- `--version <VERSION>`: 최신 릴리스 대신 `1.2.0` 같은 특정 릴리스를 다운로드합니다.
...
# 특정 릴리스 다운로드
pkvsyncd upgrade --yes --version 1.2.0
```
